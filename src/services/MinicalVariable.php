<?php
/**
 * Minical plugin for Craft CMS 5.x
 *
 ...
 * @since     5.0.0
 */
class MinicalVariable extends Component
{
    // Public Methods
    // =========================================================================
     ...
     public function cal($calOptions = null)
    {
      ...
      $returnData =  $this->createCalendarLayout($calOptions);
    ...
    //  Minical::$plugin->minicalVariable->createCalendarLayout($options);
